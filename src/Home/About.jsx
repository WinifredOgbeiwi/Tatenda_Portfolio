        ...
        <section id='about' className=' pt-20'>
            <div className=' flex flex-col md:flex-row justify-center items-center md:justify-between'>
                ...
                <div className='md:w-1/2 mt-10 md:mt-0' data-aos='fade-left'>
                    ...
                    <p className='mt-5 mb-6'>I am Tatenda Carl Sakarombe. I specialize in creating stunning visuals that showcase products in their best light. My mission is to elevate your products through creative and engaging 3D solutions that exceed your expectation</p>
