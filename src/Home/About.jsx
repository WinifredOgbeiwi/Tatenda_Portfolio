        ...
        <section id='about' className=' pt-20'>
            <div className=' flex flex-col md:flex-row justify-center items-center md:justify-between'>
                ...
                <div className='md:w-1/2 mt-10 md:mt-0'>
                    <h2 className=' text-5xl font-bold'>Elevating Your <br />Products Through <br />Realistic 3D Models</h2>
                    ...
                    <h4 className="text-[#FA3C3A] font-semibold mt-10 mb-3 text-xl hover:underline" onClick={() => setShowText({ ...showText, vision: !showText.vision })}>My Vision</h4>
                    ...
                    <hr />
                    <h4 className=' text-[#FA3C3A] font-semibold mt-10 mb-3 text-xl hover:underline' onClick={() => setShowText({ ...showText, mission: !showText.mission })}>My Mission</h4>
                    {
